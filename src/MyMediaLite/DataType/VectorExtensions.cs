...
namespace MyMediaLite.DataType
{
	...
	public static class VectorExtensions
	{
		...
		/// <param name="vector">vector where vector2 is added to</param>
		/// <param name="vector2">vector2 is added to vector</param>
		static public void Add (this IList<double> vector, IList<double> vector2)
		{
			for (int i = 0; i < vector.Count; i++)
				vector [i] += vector2 [i];
		}
		...
		/// <param name="vector">Vector.</param>
		/// <param name="vector2">Vector2.</param>
		static public IList<double> AddWithReturn (this IList<double> vector, IList<double> vector2)
		{
